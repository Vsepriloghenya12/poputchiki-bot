const CACHE_NAME = 'poputchiki-pwa-v20260418a';
const APP_SHELL = [
  '/',
  '/index.html',
  '/assets/css/base.css?v=20260418a',
  '/assets/css/app.css?v=20260418a',
  '/assets/js/app.js?v=20260418a',
  '/assets/js/shared/api.js?v=20260418a',
  '/assets/js/shared/format.js?v=20260418a',
  '/assets/js/shared/pwa.js?v=20260418a',
