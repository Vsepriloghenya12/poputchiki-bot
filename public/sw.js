const CACHE_NAME = 'poputchiki-pwa-v6';
const APP_SHELL = [
  '/',
  '/index.html',
  '/assets/css/base.css?v=20260403e',
  '/assets/css/app.css?v=20260403e',
  '/assets/js/app.js?v=20260403e',
  '/assets/js/shared/api.js?v=20260403e',
  '/assets/js/shared/format.js?v=20260403e',
  '/assets/js/shared/pwa.js?v=20260403e',
