const CACHE_NAME = 'poputchiki-pwa-v20260417d';
const APP_SHELL = [
  '/',
  '/index.html',
  '/assets/css/base.css?v=20260417d',
  '/assets/css/app.css?v=20260417d',
  '/assets/js/app.js?v=20260417d',
  '/assets/js/shared/api.js?v=20260417d',
  '/assets/js/shared/format.js?v=20260417d',
  '/assets/js/shared/pwa.js?v=20260417d',
